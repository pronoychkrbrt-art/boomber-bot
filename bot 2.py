...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'check_join':
        ...
        if not unjoined:
            ...
            await update.effective_chat.send_message("🎉 <b>জয়েনিং সফল হয়েছে!</b>\n✅ এখন আপনি আমাদের বটটি ব্যবহার করতে পারবেন।\nআপনি চাইলে আমাদের পেজ ঘুরে আসতে পারেন:", parse_mode="HTML", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Visit our page", url="https://www.facebook.com/profile.php?id=61586369215014")]]))
